...
class ContentsStoryDetailActivity2 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        other_contents_btn1.setOnClickListener {
            startActivity(Intent(this@ContentsStoryDetailActivity2, ContentsStoryDetailActivity::class.java))
        }

        // 하단의 다른 버튼2을 눌렀을 때 화면 이동
        other_contents_btn2.setOnClickListener {
            startActivity(Intent(this@ContentsStoryDetailActivity2, ContentsStoryDetailActivity3::class.java))
        }
    }
}